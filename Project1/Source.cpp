...
int main()
{
    int start = clock();
    int level=0;
    double num_of_players=0;
    cout << "if you want multiple players press (1) OR if you want to play against the computer press (2)" << endl;
    ...
    if (num_of_players == 1)
    {
        ...
        cout << "if you want the level of the game is medium press (1) OR if you want the level of the game is hard press (2) " << endl;
